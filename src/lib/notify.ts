...
const EMAIL_BRAND_LOGO_URL = "https://parveil.com/parveil-logo-email.png?v=1";
...
function buildEmailBrandHeader() {
  return `<img src="${EMAIL_BRAND_LOGO_URL}" alt="" width="140" height="49" style="display:block;border:0;outline:none;text-decoration:none;width:140px;height:auto;max-width:140px;" />`;
}
