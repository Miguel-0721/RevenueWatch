...
export const demoAccounts: DemoAccount[] = [
  ...
  },
  {
    ...
    cta: "Review Issue",
    failureSeries: [
      { time: "00:00", failures: 1 },
      { time: "01:00", failures: 0 },
      { time: "02:00", failures: 1 },
      { time: "03:00", failures: 1 },
      { time: "04:00", failures: 0 },
      { time: "05:00", failures: 2 },
      { time: "06:00", failures: 1 },
      { time: "07:00", failures: 3 },
      { time: "08:00", failures: 5 },
      { time: "09:00", failures: 7 },
      { time: "10:00", failures: 10 },
      { time: "11:00", failures: 13 },
      { time: "12:00", failures: 18 },
      { time: "13:00", failures: 22 },
      { time: "14:00", failures: 25 },
      { time: "15:00", failures: 28 },
    ],
  },
  {
    id: "acct_demo_cedar",
  ...
  },
  {
    ...
    cta: "Review Issue",
    failureSeries: [
      { time: "00:00", failures: 0 },
      { time: "01:00", failures: 1 },
      { time: "02:00", failures: 0 },
      { time: "03:00", failures: 1 },
      { time: "04:00", failures: 1 },
      { time: "05:00", failures: 2 },
      { time: "06:00", failures: 2 },
      { time: "07:00", failures: 3 },
      { time: "08:00", failures: 4 },
      { time: "09:00", failures: 6 },
      { time: "10:00", failures: 8 },
      { time: "11:00", failures: 10 },
      { time: "12:00", failures: 12 },
