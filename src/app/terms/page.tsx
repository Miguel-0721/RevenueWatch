      ...
      <div className="rw-shell legal-container">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            uninterrupted availability or error-free operation at all times.
          </p>
        </section>
        ...
        <section className="legal-section">
          <h2>Termination</h2>
          <p>
            We may suspend or terminate access to the service if necessary for
            security, abuse prevention, legal compliance, or operational reasons.
          </p>
          <p>
            Subscriptions can be cancelled at any time. No refunds are issued for
